...
const variant = {
    ...
    visible: { opacity: 1, x: 0, transition: { duration: 0.5, when: "beforeChildren", staggerChildren: 0.3 },},
    }
    ...
    <motion.div id='about' className='w-full md:h-screen p-2 flex items-center py-8'>
        <motion.div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <motion.div className='col-span-2 ' variants={variant} initial={"hidden"} whileInView={"visible"}>
                ...
                <motion.p className='py-2 text-xl' variants={pVariant}>
            ...
            <motion.div initial={{opacity: 0, y:'5rem'}} whileInView={{opacity: 1, y:0}} transition={{delay: 0.5, duration: 1}} className="w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4">
