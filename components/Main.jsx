        ...
        <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <p className='text-xl tracking-widest'>I have a passion for building beautiful and functional websites, and I am constantly learning and improving my skills. I am excited to share my work with you and hope you enjoy my portfolio.</p>
                    <div className="flex items-center justify-around m-auto max-w-[330px] py-4 gap-5">
                        <div className="text-3xl rounded shadow-lg shadow-gray-400 p-5 cursor-pointer animate-all-in">
                            <FaLinkedin/>
                        </div>
                        <div className="text-3xl rounded shadow-lg shadow-gray-400 p-5 cursor-pointer animate-all-in">
                            <FaGithub/>
                        ...
                        <div className="text-3xl rounded shadow-lg shadow-gray-400 p-5 cursor-pointer
                        animate-all-in">
                            <FaFreeCodeCamp/>
                        </div>
                    </div>
